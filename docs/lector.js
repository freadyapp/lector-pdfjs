...
let pdfs = {
  algorythms:
    "https://freadypublic.s3.eu-central-1.amazonaws.com/Data+Structures+and+Algorithms+in+Java%2C+6th+Edition%2C+2014.pdf",
  "energy star":
    "https://freadypublic.s3.eu-central-1.amazonaws.com/ENERGY+STAR.pdf",
  "reasoning and logic": "/docs/pdfs/dicks.pdf",
  fready:
    "https://freadypublic.s3.eu-central-1.amazonaws.com/pdfs/cover+pdf.pdf",
  schema:
    "https://freadypublic.s3.eu-central-1.amazonaws.com/pdfs/dbass2pages.pdf",
  accounting:
    "https://freadypublic.s3.eu-central-1.amazonaws.com/pdfs/Financial+Accounting.pdf",
  economics:
    "https://freadypublic.s3.eu-central-1.amazonaws.com/pdfs/Modern+Principles+of+Economics+copy.pdf",
  "psopy psopy":
    "https://freadypublic.s3.eu-central-1.amazonaws.com/pdfs/Organizational+Behaviour+17th+Edition.pdf",
  fucked:
    "https://freadypublic.s3.eu-central-1.amazonaws.com/Opendoor+1Q21+Transcript+for+Freedy+test+on+pdfs.pdf",
...
params.on("paramsChange", function (params) {
  this.element
    .findAll(".option")
    .forEach((option) => option.removeClass("selected"));
  this.element
    .find(`[data-option='${params.pdfName}']`)
    .find(".option")
    .addClass("selected");
          ...
          onFetch: (p, index) => {
            ...
            p.self_activate = function () {
              if (!p.word) {
                ...
                p.querySelectorAll(".textLayer").forEach((textLayer) => {
                  // textLayer.style.border = "1px soli"

                  viewer.unclutterTextLayer(textLayer, {
